...
const DESKTOP_SESSION_KEY = 'focusforge_desktop_session_token';
const DESKTOP_SESSION_EXPIRY_KEY = 'focusforge_desktop_session_expiry';
...
export function isDesktopApp(): boolean {
  ...
  if (typeof navigator !== 'undefined') {
    ...
    if (userAgent.includes('FocusForge-Desktop') || userAgent.includes('Tauri')) {
      return true;
    }
  }
