        ...
        <section className="max-w-3xl mx-auto">
          ...
          <div className="skeuo-panel p-10 bg-white border-2 border-black shadow-[8px_8px_0px_black] ring-4 ring-black space-y-12">
            <div className="border-l-8 border-black pl-8">
              <h3 className="text-2xl font-black uppercase tracking-tighter italic mb-4">Transparency</h3>
            ...
            <div className="border-l-8 border-blue-500 pl-8">
              <h3 className="text-2xl font-black uppercase tracking-tighter italic mb-4">Data Storage</h3>
            ...
            <div className="border-l-8 border-green-500 pl-8">
              <h3 className="text-2xl font-black uppercase tracking-tighter italic mb-4">Universal Rights</h3>
              <p className="text-sm font-bold text-black/70 leading-relaxed uppercase tracking-tighter">
                GDPR / CCPA / YOUR RIGHTS. Request a full data export at any time.
              </p>
            </div>
          </div>
        </section>
