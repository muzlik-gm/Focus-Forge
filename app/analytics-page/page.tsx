...
export default function AnalyticsPage() {
  const metrics = [
    { name: 'Focus_Velocity', value: '89%', desc: 'Real-time cognitive speed telemetry.' },
    { name: 'Node_Uptime', value: '142h', desc: 'Total focus sessions in current cluster.' },
    { name: 'Sync_Latency', value: '12ms', desc: 'Global synchronization efficiency.' },
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 mt-12">
            <div className="skeuo-panel p-10 bg-white border-4 border-black shadow-[12px_12px_0px_black] ring-4 ring-black">
              <div className="flex items-center gap-4 mb-10 pb-4 border-b-2 border-black">
                ...
                <h3 className="text-2xl font-black uppercase tracking-tighter italic">Focal_Distribution_V2</h3>
              </div>
              <div className="space-y-4">
                {[80, 45, 95, 60].map((w, i) => (
                  <div key={i} className="w-full h-8 bg-zinc-100 border-2 border-black relative overflow-hidden">
                    ...
                    <span className="absolute top-1/2 left-4 -translate-y-1/2 text-[9px] font-black uppercase text-white drop-shadow-md">Node_Cluster_{i}</span>
            ...
            <div className="skeuo-panel p-10 bg-white border-4 border-black shadow-[12px_12px_0px_black] ring-4 ring-black">
              <div className="flex items-center gap-4 mb-10 pb-4 border-b-2 border-black">
                ...
                <h3 className="text-2xl font-black uppercase tracking-tighter italic">Sync_Efficiency_Hub</h3>
              </div>
              <div className="flex flex-col gap-6">
                <p className="text-sm font-bold text-black/60 uppercase leading-snug">
                  Your focus nodes are currently operating at a high density. Telemetry sync is optimized for the current cluster load.
                </p>
                <Link href="/register" className="skeuo-button bg-black text-white px-8 py-4 font-black uppercase text-xs shadow-[6px_6px_0px_blue] ring-2 ring-black w-fit group">
                  <span>Full Access Protocol</span>
